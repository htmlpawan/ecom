			...
			<div class="vertical-align-middle">
				<div class="auth-box ">
					<div class="left">
						<div class="content">
							<div class="header">
								<div class="logo text-center"><img src="<?php echo base_url(); ?>images/kt-logo.png" alt=""></div>
								<p class="lead">Login to Admin Dashboard</p>
							</div>
							<form class="form-auth-small" action="<?php echo base_url(); ?>login/validation_login" method="POST">
								<div class="form-group">
									...
									<input type="text" name="email" class="form-control" id="emailId" placeholder="User Name">
								</div>
								<div class="form-group">
