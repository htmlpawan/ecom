			...
			<div class="main-content">
				...
				<div class="row">
				   ...
				   <div class="col-md-6">
					...
					<a href="<?php echo base_url(); ?>products/category"><button type="submit" class="btn btn-info" name="submit" title="Add products"><i class='fa fa-plus'></i></button></a>
					</div>
					</div>
				</div>	
					<div class="panel panel-headline ">
						<div class="panel-body">
						 <table class="table table-striped table-bordered" id="productList">
										...
										{
											echo "<tr><td>".$no++."</td><td>".$row['title']."</td><td style='width: 20%;'><img style='width: 50%;' src='".base_url()."uploads/category/".$row['image']."'></td><td>";
