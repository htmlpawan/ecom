					...
					<div class="panel panel-headline">
						<div class="panel-body">
						 <table class="table table-striped table-bordered" id="productList">
										...
										{
										echo "<tr><td>".$no++."</td><td>".$row['title']."</td><td>".$row['category']."</td><td>".$row['price']."</td><td>".$row['quantity']."</td><td><button onclick='showImage(".$row['id'].")' class='btn btn-info'><i class='fa fa-picture-o'></button></i> </td> <td><a href='editproduct/".$row['id']."' class='btn btn-success'><i class='fa fa-pencil-square-o'></i></a></td>
