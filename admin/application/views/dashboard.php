							...
							<div class="row">
								<div class="col-md-3"><a href="products/productlist">
									<div class="metric">
										...
										<p>
											<span class="number"> <?php print_r($row['product_total']); ?></span>
											<span class="title">Products</span>
										</p>
									</div></a>
								</div>
								 <div class="col-md-3"><a href="products/categorylist">
									<div class="metric">
										<span class="icon"><i class="fa fa-newspaper-o"></i></span>
										<p>
											<span class="number"><?php print_r($row['category_total']); ?></span>
