		...
		<nav class="navbar navbar-default navbar-fixed-top">
			<div class="brand">
				<a href="dashboard.php">
					<img src="<?php echo base_url(); ?>assets/img/opencart.png" class="img-responsive logo img-fluid">
				</a>
			</div>
				...
				<nav>
					<ul class="nav">
					   ...
					   <?php $active = ($urlName=="productlist") ? 'active' : '';?>
						...
						<?php $active = ($urlName=="category") ? 'active' : '';?>
						<li><a href="<?php echo base_url(); ?>products/category" class="<?php echo $active; ?>"><i class="fa fa-cubes"></i><span>Add Category</span></a></li>
						
					   <?php $active = ($urlName=="categorylist") ? 'active' : '';?>
						<li><a href="<?php echo base_url(); ?>products/categorylist" class="<?php echo $active; ?>"><i class="fa fa-list"></i><span>Category List</span></a></li>
